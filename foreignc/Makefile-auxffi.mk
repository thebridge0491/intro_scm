...
#CPPFLAGS := $(CPPFLAGS) -Iinclude -I$(ffi_incdir) `sagittarius-config -I`
...
#		-o $(parent)-classic_stubs.$(shlibext) $(LDLIBS)
	-cd build ; gauche-package compile -v --cppflags="-I.. -I$(ffi_incdir)" \
		--ldflags="-L$(ffi_libdir) -L." --libs="-lintro_c-practice" \
		$(parent)-classic_stubs classic_stubslib.c ../$(parent)/classic_stubs.c
#	using sagittarius-package
#	-cd build ; sagittarius-package .. . $(parent)/classic_stubslib.stub
